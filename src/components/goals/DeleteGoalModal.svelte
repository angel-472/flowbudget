  ...
  >
    ...
    <div class="w-full max-w-md bg-zinc-900 border border-zinc-800 rounded-xl p-5">
      <div class="flex items-start gap-3">
        ...
        <div class="min-w-0">
          <h3 class="text-base font-bold text-zinc-100">Delete Savings Goal?</h3>
          <p class="mt-1 text-sm text-zinc-400">
            Are you sure you want to delete
            <span class="font-medium text-zinc-200">{goal.name}</span>? This will
            remove its balance of {formatCurrency(goal.balance)} and can't be
            undone.
          </p>
        </div>
      </div>
