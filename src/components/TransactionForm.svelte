...
<div class="fixed inset-0  bg-black/50 flex items-center justify-center z-50  {isOpen ? '' : 'hidden'}">
  <div class="p-6 bg-white dark:bg-gray-800 rounded-xl space-y-4 shadow-2xl">
