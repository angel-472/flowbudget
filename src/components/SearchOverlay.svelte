...
>
  <div
    class="w-full max-w-2xl bg-white dark:bg-gray-900 rounded-2xl shadow-2xl border border-gray-200 dark:border-gray-800 overflow-hidden"
    role="dialog"
    aria-modal="true"
  ...
  >
    ...
    <div class="flex items-center gap-3 px-4 py-3 border-b border-gray-100 dark:border-gray-800">
      <Search size={18} class="shrink-0 text-gray-400 dark:text-gray-500" />
      <input
        bind:this={inputEl}
        bind:value={query}
      ...
      {:else}
        <div class="divide-y divide-gray-100 dark:divide-gray-800">
          {#each results as t (t.id)}
            <button
              class="w-full flex items-center gap-3 px-4 py-3 hover:bg-gray-50 dark:hover:bg-gray-800/60 transition-colors text-left cursor-pointer"
            ...
            >
              ...
              <div class="flex-1 min-w-0">
                <p class="text-sm font-medium text-gray-900 dark:text-gray-100 truncate">{t.description}</p>
              ...
              <div class="flex flex-col items-end shrink-0 gap-0.5">
                ...
                <span class="text-xs text-gray-400 dark:text-gray-500 capitalize">{t.status}</span>
              </div>
            </button>
          {/each}
        </div>
    ...
    <!-- Footer hint -->
    <div class="px-4 py-2 border-t border-gray-100 dark:border-gray-800 text-xs text-gray-400 dark:text-gray-500 flex justify-between">
      <span>
